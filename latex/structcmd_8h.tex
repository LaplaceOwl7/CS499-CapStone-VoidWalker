\doxysection{doxygen-\/1.9.8/examples/structcmd.h File Reference}
\hypertarget{structcmd_8h}{}\label{structcmd_8h}\index{doxygen-\/1.9.8/examples/structcmd.h@{doxygen-\/1.9.8/examples/structcmd.h}}
...
{\footnotesize\ttfamily int open (\begin{DoxyParamCaption}\item[{const char \texorpdfstring{$\ast$}{*}}]{pathname,  }\item[{int}]{flags }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily int read (\begin{DoxyParamCaption}\item[{int}]{fd,  }\item[{char \texorpdfstring{$\ast$}{*}}]{buf,  }\item[{size\+\_\+t}]{count }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily size\+\_\+t write (\begin{DoxyParamCaption}\item[{int}]{fd,  }\item[{const char \texorpdfstring{$\ast$}{*}}]{buf,  }\item[{size\+\_\+t}]{count }\end{DoxyParamCaption})}
